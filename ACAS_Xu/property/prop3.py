...
smv.write("--For property 3 i.e. o1_raw is not minimal\n")
smv.write("ASSIGN\n")
...
smv.write("i1_raw := i1_coarse / 1000000000;\n")
smv.write("i2_raw := i2_coarse / 1000000000;\n")
smv.write("i3_raw := i3_coarse / 1000000000;\n")
smv.write("i4_raw := i4_coarse / 1000000000;\n")
smv.write("i5_raw := i5_coarse / 1000000000;\n")
...
smv.write("--Property 3:\n")
smv.write("LTLSPEC G X ((i1_raw < 1500) | (i1_raw > 1800) | (i2_raw < -0.06) | (i2_raw > 0.06) | (i3_raw < 3.1) | (i4_raw < 980) | (i5_raw < 960) | (flg = 0)) | F ( ((i1_raw < i1_min) | (i1_raw > i1_max)) | ((i2_raw < i2_min) | (i2_raw > i2_max)) | ((i3_raw < i3_min) | (i3_raw > i3_max)) | ((i4_raw < i4_min) | (i4_raw > i4_max)) | ((i5_raw < i5_min) | (i5_raw > i5_max)) ) \n \n")
