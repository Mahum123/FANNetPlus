...
smv.write("--For property 1 i.e. o1_raw <= 1500\n")
smv.write("ASSIGN\n")
smv.write("    init (flg) := {0,1};\n")
smv.write("    next (flg) := (o1_raw > 1500) ? 0 : 1;\n\n")
...
smv.write("--Property 1:\n")
smv.write("LTLSPEC G X ((i1_raw < 55947.691) | (i4_raw < 1145) | (i5_raw > 60) | (flg = 1)) | F ( ((i1_raw < i1_min) | (i1_raw > i1_max)) | ((i2_raw < i2_min) | (i2_raw > i2_max)) | ((i3_raw < i3_min) | (i3_raw > i3_max)) | ((i4_raw < i4_min) | (i4_raw > i4_max)) | ((i5_raw < i5_min) | (i5_raw > i5_max)) ) \n \n")
