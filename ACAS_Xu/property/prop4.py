...
smv.write("--For property 4 i.e. o1_raw is not minimal\n")
smv.write("ASSIGN\n")
...
smv.write("i1_raw := i1_coarse * 1000;\n")
smv.write("i2_raw := i2_coarse / 10;\n")
smv.write("i3_raw := 0;\n")
smv.write("i4_raw := i4_coarse * 400;\n")
smv.write("i5_raw := i5_coarse * 400;\n")
...
smv.write("--Property 4:\n")
smv.write("LTLSPEC G X ((i1_raw < 1500) | (i1_raw > 1800) | (i2_raw < -0.06) | (i2_raw > 0.06) | (i3_raw < 0) | (i3_raw > 0) | (i4_raw < 1000) | (i5_raw < 700) | (i5_raw > 800) | (flg = 0)) | F ( ((i1_raw < i1_min) | (i1_raw > i1_max)) | ((i2_raw < i2_min) | (i2_raw > i2_max)) | ((i3_raw < i3_min) | (i3_raw > i3_max)) | ((i4_raw < i4_min) | (i4_raw > i4_max)) | ((i5_raw < i5_min) | (i5_raw > i5_max)) ) \n \n")
